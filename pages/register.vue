  ...
  <div class="flex justify-center items-center h-screen bg-gray-200 px-6">
    ...
    <div class="p-6 max-w-sm w-full bg-white shadow-md rounded-md">
      ...
      <div class="flex justify-center items-center">
          ...
          <span class="text-gray-700 font-semibold text-2xl">Registro</span>
      </div>

      <form class="mt-4" @submit.prevent="register()">

          <label class="block">
              <span class="text-gray-700 text-sm">Nombres</span>
              <input v-model="element.name" type="text" class="form-input mt-1 block w-full text-black rounded-md focus:border-indigo-600" >
          </label>
          <label class="block">
              <span class="text-gray-700 text-sm">Dirección de correo electrónico</span>
          ...
          <label class="block">
              <span class="text-gray-700 text-sm">Confirmación de contraseña</span>
              <input v-model="element.pass_" type="password" class="form-input mt-1 block w-full text-black rounded-md focus:border-indigo-600" >
          </label>
